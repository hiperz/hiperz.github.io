import{a as e}from"./chunk-L3UYHT7M.js";var n="sceneFragmentDeclaration",c=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;uniform mat4 inverseProjection;
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);var u={name:n,shader:c};var i="openpbrDielectricReflectance",f=`struct ReflectanceParams
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=f);var E={name:i,shader:f};var r="openpbrGeometryInfo",s=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=s);var T={name:r,shader:s};var o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=m);var D={name:t,shader:m};export{u as a,E as b,T as c,N as d,L as e,D as f};
