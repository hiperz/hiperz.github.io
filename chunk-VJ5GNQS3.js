import{a as e}from"./chunk-L3UYHT7M.js";var r="openpbrDielectricReflectance",a=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=a);var m={name:r,shader:a};var n="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=t);var v={name:n,shader:t};var i="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=l);var _={name:f,shader:l};export{m as a,v as b,R as c,L as d,_ as e};
