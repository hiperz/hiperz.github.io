import{a}from"./chunk-L3UYHT7M.js";var e="bumpFragmentMainFunctions",f=`#ifndef TEXRD_DEFINED
...
#endif
`;a.IncludesShadersStoreWGSL[e]||(a.IncludesShadersStoreWGSL[e]=f);var l={name:e,shader:f};var r="bumpFragmentFunctions",m=`#if defined(BUMP)
...
#endif
`;a.IncludesShadersStoreWGSL[r]||(a.IncludesShadersStoreWGSL[r]=m);var p={name:r,shader:m};var t="bumpFragment",n=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;a.IncludesShadersStoreWGSL[t]||(a.IncludesShadersStoreWGSL[t]=n);var c={name:t,shader:n};export{l as a,p as b,c};
