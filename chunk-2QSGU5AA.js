import{a as e}from"./chunk-L3UYHT7M.js";var r="morphTargetsVertexGlobalDeclaration",a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=a);var s={name:r,shader:a};var t="morphTargetsVertexDeclaration",o=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=o);var m={name:t,shader:o};var n="morphTargetsVertexGlobal",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=f);var v={name:n,shader:f};var d="morphTargetsVertex",i=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=i);var S={name:d,shader:i};export{s as a,m as b,v as c,S as d};
