import{a as Se}from"./chunk-WDPFIKFV.js";import{a as ie,b as ae,c as ne,d as fe,e as oe,f as te,g as ce,h as le,i as de,j as se,k as Ee,l as me}from"./chunk-QW7ZJFXU.js";import{a as j}from"./chunk-MRI626UC.js";import{a as $,b as re}from"./chunk-6GT2RKXX.js";import{a as ee}from"./chunk-L673O6JU.js";import{a as z,b as q}from"./chunk-3NEQU4ZH.js";import{a as P,b as h,c as b,d as U,e as G,f as B,g as H,h as K,i as Q}from"./chunk-WZTP2RVA.js";import{a as k,b as X,c as w}from"./chunk-2WYWNWGD.js";import{a as y,b as W}from"./chunk-PZK6DX4M.js";import{a as Z}from"./chunk-LBF6NEVR.js";import{a as V,b as x}from"./chunk-GA7M5KUR.js";import{a as Y,b as J}from"./chunk-2CH5NDQ5.js";import{a as F}from"./chunk-XZGDY3E5.js";import{a as g}from"./chunk-JP5IOU5X.js";import{a as D}from"./chunk-3KCHJGOY.js";import{a as M}from"./chunk-ITQCPGXT.js";import{a as L,b as _}from"./chunk-BSGKLYC7.js";import{a as T}from"./chunk-Y57SIJXL.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-Q5ZUIUCT.js";var i="samplerFragmentAlternateDeclaration",Re=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=Re);var Ce={name:i,shader:Re};var a="pbrFragmentSamplersDeclaration",ue=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=ue);var pe={name:a,shader:ue};var n="pbrBlockAlbedoOpacity",ve=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=ve);var Ie={name:n,shader:ve};var f="pbrBlockReflectivity",Ae=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Ae);var Ne={name:f,shader:Ae};var o="pbrBlockAmbientOcclusion",Oe=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=Oe);var Te={name:o,shader:Oe};var t="pbrBlockAlphaFresnel",Le=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=Le);var _e={name:t,shader:Le};var c="pbrBlockAnisotropic",Me=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=Me);var De={name:c,shader:Me};var l="pbrBlockReflection",Fe=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=Fe);var ge={name:l,shader:Fe};var d="pbrBlockSheen",Pe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=Pe);var he={name:d,shader:Pe};var s="pbrBlockClearcoat",be=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=be);var Ue={name:s,shader:be};var E="pbrBlockIridescence",Ge=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Ge);var Be={name:E,shader:Ge};var m="pbrBlockSubSurface",ye=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=ye);var We={name:m,shader:ye};var S="pbrBlockNormalFinal",Ve=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Ve);var xe={name:S,shader:Ve};var R="pbrBlockLightmapInit",He=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=He);var ke={name:R,shader:He};var C="pbrBlockGeometryInfo",Xe=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Xe);var Ye={name:C,shader:Xe};var u="pbrBlockReflectance",we=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=we);var ze={name:u,shader:we};var p="pbrBlockDirectLighting",Ke=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Ke);var qe={name:p,shader:Ke};var v="pbrBlockFinalLitComponents",Ze=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Ze);var Je={name:v,shader:Ze};var I="pbrBlockFinalUnlitComponents",Qe=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Qe);var je={name:I,shader:Qe};var A="pbrBlockFinalColorComposition",$e=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=$e);var er={name:A,shader:$e};var N="pbrBlockPrePass",rr=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=rr);var ir={name:N,shader:rr};var O="pbrPixelShader",ar=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=ar);var nr=[P,h,M,D,Se,F,ie,b,y,Ce,$,pe,V,L,g,Y,H,T,ae,ne,fe,x,B,j,U,oe,te,ee,ce,G,le,de,re,k,X,W,z,Ie,Ne,Te,_e,De,ge,he,Ue,Be,We,_,se,w,xe,K,ke,Ye,ze,qe,q,Je,je,er,Z,J,Ee,ir,Q,me];for(let r of nr)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var da={name:O,shader:ar};export{da as pbrPixelShaderWGSL};
