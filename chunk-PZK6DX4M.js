import{a as e}from"./chunk-L3UYHT7M.js";var r="samplerFragmentDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var t={name:r,shader:i};var o="reflectionFunction",f=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=f);var l={name:o,shader:f};export{t as a,l as b};
