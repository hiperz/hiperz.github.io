import{a as e}from"./chunk-L3UYHT7M.js";var r="morphTargetsVertexGlobalDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);var x={name:r,shader:f};var t="morphTargetsVertexDeclaration",d=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=d);var p={name:t,shader:d};var n="morphTargetsVertexGlobal",i=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=i);var l={name:n,shader:i};var o="morphTargetsVertex",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=T);var s={name:o,shader:T};export{x as a,p as b,l as c,s as d};
