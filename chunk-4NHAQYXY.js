import{a as Ae}from"./chunk-NVPRJSZO.js";import{a as te,b as ce,c as le,d as de,e as se,f as Ee,g as Re,h as me,i as Ce,j as Se,k as ue}from"./chunk-HDVJG57Z.js";import{a as ae}from"./chunk-IFMF4VYX.js";import{a as re,b as fe}from"./chunk-DWBIPG4E.js";import{a as oe}from"./chunk-73DFZNDF.js";import{a as x,b as j,c as $}from"./chunk-ZGC4NVZD.js";import{a as U,b as y,c as B,d as G,e as V,f as H,g as k,h as K,i as Q,j as ne}from"./chunk-G2SPCCRY.js";import{a as z,b as Z,c as J}from"./chunk-YF3XG2D4.js";import{a as X,b as W}from"./chunk-KHMCXC44.js";import{a as ee}from"./chunk-CR3CLAX4.js";import{a as Y,b as w}from"./chunk-2NXMWS2L.js";import{a as P}from"./chunk-TKT3KB2A.js";import{a as b}from"./chunk-7G7PZIN4.js";import{a as q,b as ie}from"./chunk-QZI53D5F.js";import{a as M,b as F}from"./chunk-BJMKR4N6.js";import{a as g}from"./chunk-ZTCEZ5U3.js";import{a as h}from"./chunk-C5AI2TBB.js";import{a as D}from"./chunk-2YI4UVXA.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-Q5ZUIUCT.js";var n="pbrFragmentDeclaration",Ie=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=Ie);var ve={name:n,shader:Ie};var a="samplerFragmentAlternateDeclaration",Te=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=Te);var Ne={name:a,shader:Te};var r="pbrFragmentSamplersDeclaration",pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=pe);var Oe={name:r,shader:pe};var o="pbrBlockAlbedoOpacity",Le=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=Le);var _e={name:o,shader:Le};var f="pbrBlockReflectivity",De=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=De);var Me={name:f,shader:De};var t="pbrBlockAmbientOcclusion",Fe=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=Fe);var he={name:t,shader:Fe};var c="pbrBlockAlphaFresnel",ge=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=ge);var Pe={name:c,shader:ge};var l="pbrBlockAnisotropic",be=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=be);var Ue={name:l,shader:be};var d="pbrBlockReflection",ye=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ye);var Be={name:d,shader:ye};var s="pbrBlockSheen",Ge=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=Ge);var Ve={name:s,shader:Ge};var E="pbrBlockClearcoat",He=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=He);var xe={name:E,shader:He};var R="pbrBlockIridescence",ke=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=ke);var Xe={name:R,shader:ke};var m="pbrBlockSubSurface",We=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=We);var Ye={name:m,shader:We};var C="pbrBlockReflectance0",we=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=we);var Ke={name:C,shader:we};var S="pbrClusteredLightingFunctions",ze=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ze);var Ze={name:S,shader:ze};var u="pbrBlockNormalFinal",qe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=qe);var Je={name:u,shader:qe};var A="pbrBlockLightmapInit",je=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=je);var Qe={name:A,shader:je};var I="pbrBlockGeometryInfo",$e=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=$e);var ei={name:I,shader:$e};var v="pbrBlockReflectance",ii=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ii);var ni={name:v,shader:ii};var T="pbrBlockDirectLighting",ai=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ai);var ri={name:T,shader:ai};var N="pbrBlockFinalLitComponents",oi=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=oi);var fi={name:N,shader:oi};var p="pbrBlockFinalUnlitComponents",ti=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ti);var ci={name:p,shader:ti};var O="pbrBlockFinalColorComposition",li=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=li);var di={name:O,shader:li};var L="pbrBlockPrePass",si=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=si);var Ei={name:L,shader:si};var _="pbrPixelShader",Ri=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[_]||(e.ShadersStore[_]=Ri);var mi=[y,B,U,ve,h,g,Ae,P,te,G,V,X,Ne,re,Oe,Y,M,b,q,K,D,ce,le,de,w,k,ae,H,se,Ee,oe,Re,me,fe,z,Z,W,j,_e,Me,he,Pe,Ue,Be,Ve,xe,Xe,Ye,x,Ke,Ze,F,Ce,J,Je,Q,Qe,ei,ni,ri,$,fi,ci,di,ee,ie,Se,Ei,ne,ue];for(let i of mi)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);var Ua={name:_,shader:Ri};export{Ua as pbrPixelShader};
