import{a as z,b as K}from"./chunk-ZTE6QU35.js";import{a as V,b as O}from"./chunk-NLHXC6QB.js";import{d as $,l as B,p as R}from"./chunk-WWN7F7WH.js";import{W as a,Z as w,aa as S,d as _,g as N,h as E,i as q,ka as P,la as J,ma as H}from"./chunk-GPQILTHO.js";import{Ab as p,Bb as r,Cb as G,Gc as C,Hb as T,Jb as M,Kb as U,Sa as f,Sb as u,T as l,Ta as x,U as c,Z as m,Zb as D,cb as s,db as g,e as nt,f as it,gb as y,ia as d,qb as h,rb as b,tb as A,ub as v,vb as I}from"./chunk-W2VSJGNJ.js";var Q=nt(L=>{"use strict";var pt=function(){function t(){}return t.UUID=function(){if(typeof window<"u"&&typeof window.crypto<"u"&&typeof window.crypto.getRandomValues<"u"){var i=new Uint16Array(8);return window.crypto.getRandomValues(i),this.pad4(i[0])+this.pad4(i[1])+"-"+this.pad4(i[2])+"-"+this.pad4(i[3])+"-"+this.pad4(i[4])+"-"+this.pad4(i[5])+this.pad4(i[6])+this.pad4(i[7])}else return this.random4()+this.random4()+"-"+this.random4()+"-"+this.random4()+"-"+this.random4()+"-"+this.random4()+this.random4()+this.random4()},t.pad4=function(i){for(var e=i.toString(16);e.length<4;)e="0"+e;return e},t.random4=function(){return Math.floor((1+Math.random())*65536).toString(16).substring(1)},t}();L.UUID=pt});var ot=it(Q());var ut=({dt:t})=>`
.p-inputgroup,
