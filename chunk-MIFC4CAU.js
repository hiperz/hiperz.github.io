import{a as ee,b as re,c as te,d as ae,e as ie,f as oe,g as ne,h as fe,i as se,j as le,k as ce,l as me}from"./chunk-QW7ZJFXU.js";import{a as $}from"./chunk-EZZADKEC.js";import{a as V}from"./chunk-MRI626UC.js";import{a as Z,b as q,c as K,d as Q,e as J}from"./chunk-VJ5GNQS3.js";import{a as k,b as j}from"./chunk-6GT2RKXX.js";import{a as Y}from"./chunk-L673O6JU.js";import{a as F,b as D,c as O,d as C,e as P,f as G,g as z,h as w,i as B}from"./chunk-WZTP2RVA.js";import{a as x,b as M}from"./chunk-PZK6DX4M.js";import{a as X}from"./chunk-LBF6NEVR.js";import{a as W,b as y}from"./chunk-GA7M5KUR.js";import{a as U,b as H}from"./chunk-2CH5NDQ5.js";import{a as A}from"./chunk-XZGDY3E5.js";import{a as L}from"./chunk-JP5IOU5X.js";import{a as T}from"./chunk-3KCHJGOY.js";import{a as N}from"./chunk-ITQCPGXT.js";import{a as R,b}from"./chunk-BSGKLYC7.js";import{a as I}from"./chunk-Y57SIJXL.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-Q5ZUIUCT.js";var t="openpbrFragmentSamplersDeclaration",_e=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=_e);var de={name:t,shader:_e};var a="openpbrNormalMapFragmentMainFunctions",ue=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=ue);var pe={name:a,shader:ue};var i="openpbrNormalMapFragmentFunctions",ge=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=ge);var ve={name:i,shader:ge};var o="openpbrConductorReflectance",Ee=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=Ee);var Se={name:o,shader:Ee};var n="openpbrAmbientOcclusionFunctions",he=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=he);var Ie={name:n,shader:he};var f="openpbrVolumeFunctions",Re=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Re);var be={name:f,shader:Re};var s="openpbrNormalMapFragment",Ne=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Ne);var Te={name:s,shader:Ne};var l="openpbrBlockNormalFinal",Ae=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=Ae);var Le={name:l,shader:Ae};var c="openpbrBaseLayerData",Fe=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=Fe);var De={name:c,shader:Fe};var m="openpbrCoatLayerData",Oe=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=Oe);var Ce={name:m,shader:Oe};var _="openpbrThinFilmLayerData",Pe=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Pe);var Ge={name:_,shader:Pe};var d="openpbrFuzzLayerData",xe=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=xe);var Me={name:d,shader:xe};var u="openpbrAmbientOcclusionData",We=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=We);var ye={name:u,shader:We};var p="openpbrBackgroundTransmission",ze=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ze);var Ue={name:p,shader:ze};var g="openpbrEnvironmentLighting",we=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=we);var Xe={name:g,shader:we};var v="openpbrDirectLightingInit",He=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=He);var Be={name:v,shader:He};var E="openpbrDirectLighting",Ve=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Ve);var ke={name:E,shader:Ve};var S="openpbrBlockPrePass",Ye=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Ye);var Ze={name:S,shader:Ye};var h="openpbrPixelShader",je=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=je);var qe=[F,D,N,T,$,A,ee,O,x,k,de,W,R,L,U,z,I,re,te,ae,y,G,V,C,ie,oe,Y,ne,P,fe,se,j,pe,ve,M,Z,Se,Ie,q,K,be,b,le,Te,Le,De,J,Q,Ce,Ge,Me,ye,w,Ue,Xe,Be,ke,X,H,ce,Ze,B,me];for(let r of qe)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var kt={name:h,shader:je};export{kt as openpbrPixelShaderWGSL};
