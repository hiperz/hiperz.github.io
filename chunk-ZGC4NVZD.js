import{a as e}from"./chunk-L3UYHT7M.js";var i="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);var s={name:i,shader:n};var t="decalFragment",f=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);var l={name:t,shader:f};var o="lightFragment",d=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=d);var c={name:o,shader:d};export{s as a,l as b,c};
