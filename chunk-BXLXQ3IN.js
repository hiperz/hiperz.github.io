import{a as e}from"./chunk-L3UYHT7M.js";var t="uvAttributeDeclaration",v=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=v);var S={name:t,shader:v};var i="prePassVertexDeclaration",l=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=l);var O={name:i,shader:l};var r="samplerVertexDeclaration",p=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=p);var N={name:r,shader:p};var f="lightVxUboDeclaration",c=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=c);var L={name:f,shader:c};var a="vertexPullingDeclaration",_=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=_);var M={name:a,shader:_};var n="vertexPullingVertex",x=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=x);var R={name:n,shader:x};var o="prePassVertex",m=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=m);var C={name:o,shader:m};var d="uvVariableDeclaration",V=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=V);var B={name:d,shader:V};var s="samplerVertexImplementation",E=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=E);var j={name:s,shader:E};var u="shadowsVertex",I=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=I);var q={name:u,shader:I};export{S as a,O as b,N as c,L as d,M as e,R as f,C as g,B as h,j as i,q as j};
