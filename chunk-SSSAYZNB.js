...
<p data-ke-size="size16">In the next post, we will learn how to filter the target files for deployment and create\r
    shortcut icons on the desktop and start menu.</p>`},{category:"wpf",id:35,content:`<p data-ke-size="size16">\u203B. This screenshot is based on Visual Studio 2022.</p>\r
<p data-ke-size="size16">&nbsp;</p>\r
...
<p data-ke-size="size16">&nbsp;</p>\r
`}];var Xs=class t{constructor(n){this.router=n;this.items=[{label:"Games",items:[...kr]},{label:"JSON Tools",items:[...Tr]},{label:"Other Tools",items:[...Cr]}];let e=[...Gs].reverse(),r=Js.map(o=>A(h({},o),{count:e.filter(c=>c.category===o.category).length}));this.flatList.push(Sr),this.flatList.push(...e,...kr,...Tr,...Cr,...r,...Rr);let i={label:"Trading",items:[...Rr]};this.items.push(i);let s={label:"Blog",items:[Sr,...r]};this.items.push(s),this.flatList.forEach(o=>o.command=c=>this.navigateTo(c))}history$=new P([]);get currentMenu(){return this.history$.value.at(-1)}home=A(h({},Hs),{command:n=>this.navigateTo(n)});flatList=[];items=[];getUrl(n){return"/"+n.routerLink}getArticleUrl(n){return n.routerLink}navigateTo(n){let e=n.item;this.router.navigateByUrl(e.routerLink)}navigateToArticle(n){let e=A(h({},n),{routerLink:this.getArticleUrl(n)});this.router.navigateByUrl(e.routerLink)}getRelevantArticles(n){let e=[];if(n){let r=this.flatList.filter(s=>!s.count&&s.category===n.category),i=r.indexOf(n);[-2,-1,1,2].forEach(s=>{let o=i+s;o>=0&&o<r.length&&e.push(r[o])})}return e}getMenuByUrl(n){return this.flatList.find(e=>"/"+e.routerLink===n)}getBlogContentByUrl(n){let e=n.split("/"),r=e.at(-2)??"",i=e.at(-1)??"";return Mr.find(s=>s.category===r&&s.id===+i)}getBlogContent(n,e){return Mr.find(r=>r.category===n&&r.id===e)}static \u0275fac=function(e){return new(e||t)(y(W))};static \u0275prov=w({token:t,factory:t.\u0275fac,providedIn:"root"})};export{io as a,gl as b,ml as c,qi as d,_l as e,Bl as f,Zi as g,na as h,Vl as i,$l as j,$ as k,oe as l,Fa as m,W as n,as as o,dd as p,ud as q,hd as r,fd as s,rl as t,Gs as u,Js as v,Mr as w,Xs as x};
