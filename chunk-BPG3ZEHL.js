...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=ue);var ge={name:i,shader:ue};var r="openpbrFragmentSamplersDeclaration",pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=pe);var Ee={name:r,shader:pe};var t="openpbrNormalMapFragmentMainFunctions",ve=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ve);var he={name:t,shader:ve};var n="openpbrNormalMapFragmentFunctions",Re=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=Re);var Ie={name:n,shader:Re};var a="openpbrConductorReflectance",Se=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=Se);var Te={name:a,shader:Se};var s="openpbrAmbientOcclusionFunctions",Ae=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=Ae);var be={name:s,shader:Ae};var c="openpbrVolumeFunctions",Ne=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Ne);var Fe={name:c,shader:Ne};var f="openpbrNormalMapFragment",Le=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=Le);var De={name:f,shader:Le};var l="openpbrBlockNormalFinal",Oe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=Oe);var Ce={name:l,shader:Oe};var _="openpbrBaseLayerData",Pe=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Pe);var Me={name:_,shader:Pe};var d="openpbrCoatLayerData",xe=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=xe);var Ge={name:d,shader:xe};var m="openpbrThinFilmLayerData",ye=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ye);var ze={name:m,shader:ye};var u="openpbrFuzzLayerData",Ue=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Ue);var Xe={name:u,shader:Ue};var g="openpbrAmbientOcclusionData",we=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=we);var We={name:g,shader:we};var p="openpbrBackgroundTransmission",He=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=He);var Be={name:p,shader:He};var E="openpbrEnvironmentLighting",Ve=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Ve);var ke={name:E,shader:Ve};var v="openpbrDirectLightingInit",Ye=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=Ye);var Ze={name:v,shader:Ye};var h="openpbrDirectLighting",je=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=je);var qe={name:h,shader:je};var R="openpbrBlockPrePass",Ke=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Ke);var Qe={name:R,shader:Ke};var I="openpbrPixelShader",Je=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=Je);var $e=[O,C,j,D,ge,b,N,ie,F,re,P,M,y,Z,Ee,U,T,L,W,w,S,te,ne,ae,X,G,Y,x,se,ce,q,fe,le,Q,he,Ie,z,K,Te,be,J,$,Fe,A,_e,De,Ce,Me,oe,ee,Ge,ze,Xe,We,H,Be,ke,Ze,qe,B,V,de,Qe,k,me];for(let o of $e)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);var ir={name:I,shader:Je};export{ir as openpbrPixelShader};
