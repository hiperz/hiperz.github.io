import{a as e}from"./chunk-L3UYHT7M.js";var t="decalFragmentDeclaration",n=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var E={name:t,shader:n};var o="prePassDeclaration",h=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=h);var C={name:o,shader:h};var a="oitDeclaration",p=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=p);var P={name:a,shader:p};var i="lightFragmentDeclaration",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=f);var M={name:i,shader:f};var r="lightUboDeclaration",u=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=m);var b={name:s,shader:m};var c="shadowsFragmentFunctions",S=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=S);var N={name:c,shader:S};var v="textureRepetitionFunctions",w=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=w);var W={name:v,shader:w};var l="depthPrePass",x=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=x);var Z={name:l,shader:x};var d="oitFragment",D=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=D);var Y={name:d,shader:D};export{E as a,C as b,P as c,M as d,I as e,b as f,N as g,W as h,Z as i,Y as j};
