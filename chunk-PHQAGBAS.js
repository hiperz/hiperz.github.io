import{a as e}from"./chunk-L3UYHT7M.js";var t="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=m);var E={name:t,shader:m};var i="bakedVertexAnimationDeclaration",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=f);var N={name:i,shader:f};var r="instancesVertex",d=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);var u={name:r,shader:d};var a="bonesVertex",s=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);var V={name:a,shader:s};var n="bakedVertexAnimation",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=o);var p={name:n,shader:o};export{E as a,N as b,u as c,V as d,p as e};
