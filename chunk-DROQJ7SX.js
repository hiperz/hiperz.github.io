import{p as f}from"./chunk-ZL7XJN45.js";import{Jc as y,X as b,a as o,aa as k,b as i,p as u}from"./chunk-VECOZZOS.js";var x="JunaPapa's Blog is a comprehensive website where you can find a variety of games I developed for casual play on the web, useful developer tools, and posts with development tips and troubleshooting advice.",M=(t=>(t[t.format=0]="format",t[t.string2Json=1]="string2Json",t[t.json2String=2]="json2String",t[t.json2CSharp=3]="json2CSharp",t[t.base64Encode=4]="base64Encode",t[t.base64Decode=5]="base64Decode",t))(M||{}),p=[{label:"\u{1F680} Speed Typing A to Z \u{1F680}",routerLink:"/games/speedatoz",data:{title:"\u{1F680} Speed Typing A to Z \u{1F680}",subTitle:"Try typing alphabet A to Z as quick as you can!"}}],c={label:"Blog Posts",icon:"pi pi-list",items:[],routerLink:"/article-list"},w=[{label:"C#",icon:"pi pi-folder",routerLink:"/article-category-list/csharp",category:"csharp"},{label:"WPF",icon:"pi pi-folder",routerLink:"/article-category-list/wpf",category:"wpf"},{label:"JavaScript/TypeScript",icon:"pi pi-folder",routerLink:"/article-category-list/jsts",category:"jsts"}],d=[{label:"JSON to C# Class",icon:"pi pi-wrench",routerLink:"/json-tools/json-to-csclass",data:{title:"JSON to C# Class",subTitle:"Convert JSON to C# Class",sampleButtonLabel:"Load Sample JSON",actionButtonLabel:"Generate C# Code",mode:3}},{label:"JSON Formatter",icon:"pi pi-wrench",routerLink:"/json-tools/formatter",data:{title:"JSON Formatter",subTitle:"Automatically format JSON string with indentations",sampleButtonLabel:"Load Sample JSON",actionButtonLabel:"Format JSON",mode:0}},{label:"Quote JSON text",icon:"pi pi-wrench",routerLink:"/json-tools/json-to-string",data:{title:"Quote JSON text",subTitle:"Convert a JSON object to a string with quotes.",sampleButtonLabel:"Load Sample JSON",actionButtonLabel:"Quote JSON",mode:2}},{label:"Unquote JSON text",icon:"pi pi-wrench",routerLink:"/json-tools/string-to-json",data:{title:"Unquote JSON text",subTitle:"Removes quotes from a quoted JSON string.",sampleButtonLabel:"Load Sample String",actionButtonLabel:"Unquote JSON",mode:1}}],m=[{label:"UUID Generator",icon:"pi pi-wrench",routerLink:"/other-tools/uuid-generator",data:{title:"UUID Generator",subTitle:"Generate UUID"}},{label:"Base64 Encoding",icon:"pi pi-wrench",routerLink:"/other-tools/base64-encode",data:{title:"Base64 Encoding",subTitle:"Encoding image or text to base64 text",sampleButtonLabel:"Load Sample String",actionButtonLabel:"Encode Base64",mode:4}},{label:"Base64 Decoding",icon:"pi pi-wrench",routerLink:"/other-tools/base64-decode",data:{title:"Base64 Decoding",subTitle:"Decoding base64 text to image or text",sampleButtonLabel:"Load Sample String",actionButtonLabel:"Decode Base64",mode:5}},{label:"Bank Interest Calculator",icon:"pi pi-calculator",routerLink:"/other-tools/toss-interest-calc",data:{title:"Toss Bank Interest Calculator",subTitle:"A simple tool to calculate interest for Toss Bank."}}],h=[{label:"Bitcoin Market Prices",icon:"pi pi-bitcoin",routerLink:"/trading/bitcoin-prices",data:{title:"Bitcoin Market Prices",subTitle:"It compares the real-time Bitcoin market prices of Upbit and Binance, and calculates the Kimchi Premium."}}],z={label:"Home",icon:"pi pi-home",routerLink:"/"};var g=[{category:"csharp",id:23,content:`<p data-ke-size="size16">Normally, after JSON Serialization, the data is stored as a text file or in a database, but the\r
...
<p data-ke-size="size16">&nbsp;</p>\r
`}],F=[{label:"[C#] Convert enum type to string during JSON Serialization",icon:"pi pi-file",routerLink:"/articles/csharp/23",keywords:"C#, ENUM, enumToString, JSON, Serialization, \uC5F4\uAC70\uD615\uC744 \uBB38\uC790\uC5F4\uB85C \uC9C1\uB82C\uD654, \uC9C1\uB82C\uD654",category:"csharp",timestamp:"2025-01-25T14:57:50.369Z"},{label:"[C#][Json.Net] Using SelectToken/SelectTokens",icon:"pi pi-file",routerLink:"/articles/csharp/24",keywords:".NET, C#, Json.NET, jsonpath, LINQ, SelectToken, SelectTokens",category:"csharp",timestamp:"2025-01-25T16:26:11.340Z"},{label:"[C#] Swapping the Values of Two Variables",icon:"pi pi-file",routerLink:"/articles/csharp/32",keywords:"C#, C# 7.0, SWAP, tuple",category:"csharp",timestamp:"2025-01-25T17:29:59.870Z"},{label:"[C#][NLog] Creating a Callback Function That is Called Every Time a Log Message is Generated",icon:"pi pi-file",routerLink:"/articles/csharp/34",keywords:"C#, Callback, MethodCallTarget, nlog, nlog message hook",category:"csharp",timestamp:"2025-01-25T18:40:39.985Z"},{label:"[C#] 'Could not find a part of the path...' Error When Publishing a Project",icon:"pi pi-file",routerLink:"/articles/csharp/38",keywords:"C#, could not find a part of the path, publish error, Visual Studio, windows long filename",category:"csharp",timestamp:"2025-01-25T18:52:43.567Z"},{label:"[C#] Encrypting User Passwords Using the HMACSHA256 Class",icon:"pi pi-file",routerLink:"/articles/csharp/40",keywords:"C#, HAMCSHA256, hashing, SHA256, \uBE44\uBC00\uBC88\uD638 \uC554\uD638\uD654, \uC554\uD638\uD654",category:"csharp",timestamp:"2025-01-25T18:58:23.428Z"},{label:"[C#] Using C# in Jupyter Notebook",icon:"pi pi-file",routerLink:"/articles/csharp/45",keywords:"C#, C# \uB178\uD2B8\uBD81\uB9CC\uB4E4\uAE30, C#\uC744 \uC8FC\uD53C\uD130 \uB178\uD2B8\uBD81\uC5D0\uC11C, dotnet-interactive, Jupyter Notebook, jupyter\uB178\uD2B8\uBD81, Microsoft.dotnet-interactive, \uC8FC\uD53C\uD130\uB178\uD2B8\uBD81",category:"csharp",timestamp:"2025-01-25T19:00:45.693Z"},{label:"[C#] Improvements to Lambda Expressions in C# 10",icon:"pi pi-file",routerLink:"/articles/csharp/47",keywords:".net6, C#, C# lambda expression, C# \uB78C\uB2E4\uC2DD, C# \uB78C\uB2E4\uD45C\uD604\uC2DD, c#10, lambda, Lambda Expression, \uB78C\uB2E4\uC2DD, \uB78C\uB2E4\uD45C\uD604\uC2DD",category:"csharp",timestamp:"2025-01-25T19:07:37.032Z"},{label:"[C#] How to Serialize XML to JSON Using Json.NET",icon:"pi pi-file",routerLink:"/articles/csharp/53",keywords:"C#, JSON, Json.NET, Serialization, XML, XMLtoJSON",category:"csharp",timestamp:"2025-01-25T19:11:33.216Z"},{label:"[C#][.NET] Creating an MSI Installer with WixSharp",icon:"pi pi-file",routerLink:"/articles/csharp/78",keywords:".NET, Installer GUI, WixSharp, WixToolset, wpf",category:"csharp",timestamp:"2025-01-25T19:20:46.464Z"},{label:"[WPF/CommunityToolkit.Mvvm] 1. Write boilerplate code after creating the project",icon:"pi pi-file",routerLink:"/articles/wpf/35",keywords:".net6, Boilerplate, CommunityToolkit.Mvvm, DependencyInjection, INotifyPropertyChanged, mvvm, MVVM Boilerplate, ObservableObject, ViewModel View\uC5D0 \uBC14\uC778\uB529, wpf",category:"wpf",timestamp:"2025-01-29T13:48:47.803Z"},{label:"[WPF/CommunityToolkit.Mvvm] 2. Create a ViewModel and bind its member variables to the View",icon:"pi pi-file",routerLink:"/articles/wpf/44",keywords:".net6, CommunityToolkit.Mvvm, mvvm, ObservableObject, ObservableProperty, Partial Class, wpf, \uB2F7\uB1376",category:"wpf",timestamp:"2025-01-29T14:21:12.869Z"},{label:"[WPF/CommunityToolkit.Mvvm] 3. ObservableProperty\uC758 Change event callbacks",icon:"pi pi-file",routerLink:"/articles/wpf/90",keywords:".net8, CommunityToolkit.Mvvm, mvvm, ObservableObject, ObservableProperty, Partial Class, propertychanged #changeeventcallbacks, wpf",category:"wpf",timestamp:"2025-01-29T16:22:25.138Z"},{label:"[WPF/CommunityToolkit.Mvvm] 4. WeakReferenceMessenger",icon:"pi pi-file",routerLink:"/articles/wpf/52",keywords:"C#, CommunityToolkit, mvvm, WeakReferenceMessenge, wpf",category:"wpf",timestamp:"2025-01-29T16:23:48.988Z"},{label:"How to use NextJS + Prisma + PlanetScale",icon:"pi pi-file",routerLink:"/articles/jsts/6",keywords:"nextjs, PlanetScale, Prisma, pscale, reactjs, SCOOP, serverless, ServerlessDB, ServerlessFunctions",category:"jsts",timestamp:"2025-01-31T12:08:02.943Z"},{label:"[Angular][Google Search Console] Redirect issue",icon:"pi pi-file",routerLink:"/articles/jsts/92",keywords:"angular, customurlserializer, defaulturlserializer, gihub, google serach console, redirect issue, SEO, SPA",category:"jsts",timestamp:"2025-01-31T18:02:37.117Z"}];var v=class l{constructor(e){this.router=e}history$=new u([]);get currentMenu(){return this.history$.value.at(-1)}home=i(o({},z),{command:e=>this.navigateTo(e)});flatList=[];items=[];showSideMenu=!1;isLoadingPage=!1;initialized=!1;initMenu(){if(!this.initialized){this.items=[{label:"Games",items:[...p]},{label:"JSON Tools",items:[...d]},{label:"Other Tools",items:[...m]}];let e=[...F].reverse(),n=w.map(a=>i(o({},a),{count:e.filter(t=>t.category===a.category).length}));this.flatList.push(c),this.flatList.push(...e,...p,...d,...m,...n,...h);let r={label:"Trading",items:[...h]};this.items.push(r);let s={label:"Blog",items:[c,...n]};this.items.push(s),this.flatList.forEach(a=>a.command=t=>this.navigateTo(t)),this.initialized=!0}}getUrl(e){return e.routerLink}getArticleUrl(e){return e.routerLink}navigateTo(e){this.showSideMenu=!1;let n=y.stripTrailingSlash(this.router.url).split("?")[0];if(n=n===""?"/":n,e.item.routerLink!==n){this.isLoadingPage=!0;let r=e.item;this.router.navigateByUrl(r.routerLink)}}navigateToArticle(e){let n=i(o({},e),{routerLink:this.getArticleUrl(e)});this.router.navigateByUrl(n.routerLink)}getRelevantArticles(e){let n=[];if(e){let r=this.flatList.filter(a=>!a.count&&a.category===e.category),s=r.indexOf(e);[-2,-1,1,2].forEach(a=>{let t=s+a;t>=0&&t<r.length&&n.push(r[t])})}return n}getMenuByUrl(e){return this.flatList.find(n=>n.routerLink===e)}getBlogContentByUrl(e){let n=e.split("/"),r=n.at(-2)??"",s=n.at(-1)??"";return g.find(a=>a.category===r&&a.id===+s)}getBlogContent(e,n){return g.find(r=>r.category===e&&r.id===n)}static \u0275fac=function(n){return new(n||l)(k(f))};static \u0275prov=b({token:l,factory:l.\u0275fac,providedIn:"root"})};export{x as a,M as b,w as c,g as d,F as e,v as f};
