import{a as e}from"./chunk-L3UYHT7M.js";var t="gaussianSplattingVertexDeclaration",o="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=o);var n={name:t,shader:o};var a="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=c);var v={name:a,shader:c};var s="gaussianSplatting",i=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=i);var f={name:s,shader:i};export{n as a,v as b,f as c};
