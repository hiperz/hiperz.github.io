import{a as e}from"./chunk-L3UYHT7M.js";var r="prePassDeclaration",d=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=d);var g={name:r,shader:d};var t="oitDeclaration",p=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=p);var D={name:t,shader:p};var a="lightUboDeclaration",h=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=h);var C={name:a,shader:h};var o="ltcHelperFunctions",u=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=u);var E={name:o,shader:u};var v="clusteredLightingFunctions",l=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=l);var k={name:v,shader:l};var f="shadowsFragmentFunctions",n=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=n);var b={name:f,shader:n};var s="textureRepetitionFunctions",m=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=m);var W={name:s,shader:m};var i="depthPrePass",x=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);var H={name:i,shader:x};var c="oitFragment",S=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=S);var G={name:c,shader:S};export{g as a,D as b,C as c,E as d,k as e,b as f,W as g,H as h,G as i};
